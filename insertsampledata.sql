...
INSERT OR IGNORE INTO Bookings (CustomerID, DateOfWork, DateOrdered, WorkComplete, PaymentMethod, HasPaid, Address)
...
INSERT OR IGNORE INTO Services (Name, Cost, Hours)
...
INSERT OR IGNORE INTO "Services-Bookings" (BookingID, ServiceID)
VALUES (1, 1), (1, 2), (2, 1), (3, 1), (3, 3), (4, 1), (4, 4);

INSERT OR IGNORE INTO Mowers (Name, Surname, Email, Password, Owner)
...
INSERT OR IGNORE INTO Jobs (MowerID, ServiceBookingID, HoursWorked, AmountOwed)
